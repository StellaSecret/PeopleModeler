...
const FR = {
  ...
  gdrive_not_configured: '⚠️ L\'intégration OAuth Google nécessite un ID client Google Cloud.<br>Utilisez <strong>Export / Import JSON</strong> en attendant.',
  gdrive_connect_btn: 'Se connecter à Google',
  gdrive_connecting: 'Connexion à Google Drive…',
  gdrive_connected: '✓ Connecté à Google Drive',
  gdrive_restore_confirm: 'Restaurer les profils depuis Google Drive ? Les profils locaux seront remplacés.',
  gdrive_restore_done: 'profil(s) restauré(s) depuis Google Drive.',
  gdrive_error: 'Erreur de connexion Google Drive.',
  ...
  bias_dunning_kruger_desc: 'Les incompétents surestiment leurs compétences',
  bias_impostor_desc: 'Sous-estime sa propre compétence dans un domaine',
...
const EN = {
  ...
  gdrive_not_configured: '⚠️ Google OAuth integration requires a Google Cloud client ID.<br>Use <strong>Export / Import JSON</strong> for now.',
  gdrive_connect_btn: 'Sign in with Google',
  gdrive_connecting: 'Connecting to Google Drive…',
  gdrive_connected: '✓ Connected to Google Drive',
  gdrive_restore_confirm: 'Restore profiles from Google Drive? Local profiles will be replaced.',
  gdrive_restore_done: 'profile(s) restored from Google Drive.',
  gdrive_error: 'Google Drive connection error.',
  ...
  bias_dunning_kruger_desc: 'Incompetent overestimate their skill',
  bias_impostor_desc: 'Underestimates own competence in a domain',
