...
const BIASES = [
  ...
  { id: 'DUNNING_KRUGER',label: 'Dunning-Kruger',         emoji: '🎭', desc: 'Les incompétents surestiment leurs compétences' },
  { id: 'IMPOSTOR',      label: 'Imposteur',              emoji: '🫥', desc: 'Sous-estime sa propre compétence dans un domaine' },
