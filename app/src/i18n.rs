...
mod tests {
    ...
    #[test]
    fn tr_danger_details_en() {
        let result = tr_danger_details("OCEAN volatility, Rep power struggle", Lang::En);
        assert!(!result.is_empty());
        assert_ne!(result, "OCEAN volatility, Rep power struggle");
    }

    #[test]
    fn tr_danger_details_fr() {
        let result = tr_danger_details("OCEAN volatility, Rep power struggle", Lang::Fr);
        assert!(!result.is_empty());
        assert_ne!(result, "OCEAN volatility, Rep power struggle");
    }
    ...
    fn tr_danger_details_unknown() {
        let result = tr_danger_details("Some unknown detail", Lang::En);
        assert!(!result.is_empty());
    }
